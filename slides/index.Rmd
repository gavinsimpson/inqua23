...
```{r example-mgcv-code, eval = FALSE, echo = TRUE}
m <- mgcv::gam(response ~ s(time, k = 20), # smooth of time
    data = df,                             # where to find the variables
    family = gaussian(),                   # conditional distribution of Y
    method = "REML")                       # smothing parameter method
```

❗Critically, model things forwards in time &mdash; not age ❗

See the `.R` scripts in the Github repo for the detail
